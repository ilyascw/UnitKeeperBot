...
После 11 месяцев потребность самой долго жившей группы не исчезла; регулярное
использование прервалось на этапе переразвёртывания и миграции со старой версии.
Сейчас я готовлю повторный запуск. Следующий этап — привести экраны к
единой визуальной системе и убрать «нейроночный флёр» — сходство интерфейса с
типовыми экранами, которые генерируют AI-инструменты. Для этого я планирую
использовать design-skills и провести usability-тесты со сторонними
пользователями: посмотреть, на каких экранах они останавливаются, путают действия
или теряют следующий шаг. После этого сервис будет развёрнут на отдельной VM и
домене для нескольких заинтересованных семейных групп из круга друзей.
